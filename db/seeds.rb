...
tests = Test.create!([{ title: 'HTML', level: 1, category: categories[0] }, { title: 'Ruby', level: 3, category: categories[2] }, { title: 'CSS', level: 2, category: categories[0] }, { title: 'C#', level: 3, category: categories[1]}, { title: 'Java', level: 1, category: categories[1] }])
